...
dumpdir_csv = './NLDASData/NLDAS_Data_2019_2020/'
# define the dump directory for your final .csv files
dumpdir_final = './NLDASData/NLDAS_Data_2019_2020/'
...
startdatetime = '2018-12-31 00:00:00'
enddatetime = '2020-12-31 23:00:00'
...
drivers %>% 
  ...
  write_csv(.,paste0(dumpdir_final,LakeName, '_', format(as.POSIXct(startdatetime), '%Y_%m_%d'), '_', format(as.POSIXct(enddatetime), '%Y_%m_%d'),'_alldata.csv'))
